...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This struct wraps the necessary values for oidc authentication
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
struct curlOIDCBundle{
    std::string oidc_issuer;
    std::string oidc_audience = "rucio";
...
// std::string GET_OIDC_ASYNC(curlOIDCBundle& bundle, uid_t uid, pid_t calling_pid, std::string username, std::string short_server_name);
